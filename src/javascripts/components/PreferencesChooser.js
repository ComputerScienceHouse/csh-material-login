...
export default class PreferencesChooser {
    ...
    render() {
        ...
        document.addEventListener('click', (e) => {
            if (!Array.prototype.includes.call(toggle.parentNode.querySelectorAll("*"), e.target)) {
                ClassUtil.removeClass(toggle.parentNode, 'open');
            }
        });

        // Add event listener for each background radio button
        const backgroundRadios = toggle.parentNode.querySelectorAll("input[type=radio][name=background]");
            ...
            radio.addEventListener('change', () => {
                ...
                if (radio.checked) {
                    ...
                    if (typeof enumEquiv !== "undefined") {
                        ...
                        console.error("[PreferencesChooser] Invalid background choice: " + radio.value);
                    }
                }
            });
        });
        ...
        const particlesSwitch = toggle.parentNode.querySelector("#prefShowParticles");
